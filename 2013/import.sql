...
COPY Master (playerID,birthYear,birthMonth,birthDay,birthCountry,birthState,birthCity,deathYear,deathMonth,deathDay,deathCountry,deathState,deathCity,nameFirst,nameLast,nameGiven,weight,height,bats,throws,debut,finalGame,retroID,bbrefID) FROM '/path/to/Master.csv' WITH CSV HEADER DELIMITER AS ',';
...
COPY SchoolsPlayers FROM '/path/to/SchoolsPlayers.csv' WITH CSV HEADER DELIMITER AS ',';
